...
function Permissions() {
   ...
   // const enqueueSnackbar = useSnackbar();
    ...
    const handleFormSubmit = (formData) => {
        ...
        post({ table: "access", record: formData }).then((record) => {
                // Add new row
                setRows([...rows, record]);
            ...
            enqueueSnackbar("Error adding Permission", { variant: "error" });
        }).finally(() => {
            handleClose();
        });
    };
   ...
   const handleEditSubmit = (formData) => {
    console.log('edited form data', formData.id);
        put({ table: "access", id :formData.id, updateRecord: formData }).then((record) => {
    ...
    const handleDelete = (id) => {
        remove({ table: "access", id: id }).then(() => {
    ...
    return (
        <Box m="20px">
            ...
            >
                <Header title="Permissions" subtitle="List of Permissions" />
            ...
            <Dialog open={open} onClose={handleClose} fullWidth maxWidth="lg">
                ...
                <DialogContent>
                    {editRow ? (
                        <EditForm onClose={handleClose} title="Edit Permission" handleSubmit={handleEditSubmit} initialValues={editRow} />
                    ) : (
                        <AddForm onClose={handleClose} title="Add New Permission" handleSubmit={handleFormSubmit} />
                    )}
                </DialogContent>
            ...
            <Dialog open={viewOpen} onClose={handleViewClose} fullWidth maxWidth="md">
                <DialogTitle>View Permission Level</DialogTitle>
                <DialogContent>
